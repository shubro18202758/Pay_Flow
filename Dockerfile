...
CMD ["sh", "-c", "python main.py --serve --cpu-only --skip-llm --events ${PAYFLOW_EVENTS:-1500} --accounts ${PAYFLOW_ACCOUNTS:-600} --fraud-ratio ${PAYFLOW_FRAUD_RATIO:-0.08} --dashboard-host ${PAYFLOW_HOST:-0.0.0.0} --dashboard-port ${PORT:-8000}"]
